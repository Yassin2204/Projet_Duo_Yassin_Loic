@foreach ($DataPortfolio as $DataPortfolio)
    <main id="main" class="site-main">
        <section class="site-section-small portfolio">
            <div class="container">
                <h1 class="section-title-big text-center">{{ $DataPortfolio->h1 }}</h1>
            </div>
            <div class="container-fluid">
                <div class="row" id="grid">
                    @foreach ($dynamiqueDataPortfolio as $dynamiqueDataPortfolio)
                        <div class="col-lg-fifth col-md-3 col-sm-4 col-xs-6" data-groups='["uiux"]'>
                            <a class="portfolio-link" href="#">
                                <img src="{{ asset('assets/img/' . $dynamiqueDataPortfolio->photo) }}" alt=""
                                    class="img-carousel">
                                <div class="portfolio-info">
                                    <div class="portfolio-info-top">
                                        <h3>{{ $dynamiqueDataPortfolio->sous_titre }}</h3>
                                    </div><!-- /.portfolio-info-top -->
                                    <div class="portfolio-info-bottom">
                                        <p>{{ $dynamiqueDataPortfolio->p1 }}</p>
        ...
        <section class="site-section-small section-work-with-us yellow-bg text-center">
            ...
            <div class="container">
                ...
                <p class="section-title-small white-text mb-50">Coming together is a beginning, keeping together is
                    progress, working together is success.</p>
