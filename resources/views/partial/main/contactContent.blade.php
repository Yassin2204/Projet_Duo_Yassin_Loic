@foreach ($DataContact as $DataContact )
<div class="hero hero-max-720 hero-contact background-overlay">

    <div class="hero-text">
        <h1 class="white-text">{{$DataContact->titre}}</h1>
    </div><!-- /.hero-text -->
                ...
                <div class="col-md-5 yellow-bg">
                    ...
                    <div class="site-section-small">
                        ...
                        <div class="get-in-touch">
                            ...
                            <h2 class="section-title">{{$DataContact->sous_titre}}</h2>
                            <p class="small-title mb-50">{{$DataContact->p1}}</p> 

                            <ul class="list-unstyled mb-0">
                                <li>{{$DataContact->li1}}</li>
                                <li>Phone: <a class="gray-text" href="tel:+15417543010">{{$DataContact->li2}}</a></li>
                                <li>Fax: <a class="gray-text" href="tel:+15417543010">{{$DataContact->li3}}</a></li>
                                <li><a class="white-text" href="mailto:hello@businessperfect.com">{{$DataContact->li4}}</a></li>
                            </ul>
